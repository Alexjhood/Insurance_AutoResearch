    ...
    ctx: dict[str, Any] = {
        ...
        "research_lines": {
            ...
            "principles": [
                ...
                "Keep at most 5 lines active; park a weak line before opening another.",
                ...
                "If a local incumbent is later found to be an artefact, clear it so future screening falls back to the global champion.",
            ],
            "active_lines": _compact_research_lines([line for line in research_lines if line.get("status") == "active"]),
            "parked_lines": _compact_research_lines([line for line in research_lines if line.get("status") == "parked"]),
